          ...
          <div class="col-md-9 course-text p-4 shadow">
            ...
            <div data-lesson='1' class="course-item active" data-image=''>
              ...
              <section class="body">
                  ...
                  <p>
                   Social Engineering can also be seen as the act of finding means to manipulate reliable users to reveal private information in an effort to breakthrough security measures <i>(Mitnick (2003))</i>.
                  </p>
            ...
            <div data-lesson='2' class="course-item" data-image='' data-image-credit=''>
              ...
              <section class="body">
                  <p>
                    A critical phase in cyber-attack is information gathering. In this phase, information is amassed from a myriad of sources; information that aids the attacker to launch an attack. A targeted attack is not well recognized by the victims and, therefore, affords the attacker the opportunity of leaving little or no traces of being caught or suspected by anyone. The type and stages of social engineering attacks are given below
                  </p>
              ...
              <section>
                <p>
                  In this activity, hackers use google search tools,FOCA, social media  and other applications to look for security loopholes in the computer codes used by sites and discover information about their victim. The search engine is aggressive in creating indices which sometimes result in the revelation of information being accessed by attackers in which the individual or organization that has been targeted may not know
                </p>
              ...
              <section>
                <p>
                  The next stage for the attacker is to form a relationship with the victim or his target to gain trust. Attackers build relationships with the victim for the purpose of gaining confidence in his side (Verizon, 2012 & Mann, 2008). So, the victim gets relaxed and comfortable with the attacker whose primary objective is to defraud him without any trace of suspicion. The cyber-criminal spends much time to study his victim.
                </p>

                <h3>Pretexting</h3>
                <section>
                  <p>
                    Pretexting involves creating a scenario to persuade a targeted victim to release information or perform some action. For the attacker to start building a relationship with his target, he approaches the victim under the disguise of giving him assistance in one way or the other. The social engineer attacker acts like a “good samaritan”. Then he makes the victim feel very relaxed and wins his confidence and trust before he finally launches his attack. 
                  </p>
                </section>
            ...
            <div data-lesson='3' class="course-item" data-image='' data-image-credit=''>
              ...
              <section class="body">
                ...
                Based Attacks</h3>
                  <p>
                    ...
                    For example, Dumpster diving is an activity which involves searching important information in dumpsters and recycle centers (for the target organization) (Long and Mitnick, 2008). Dumpster diving produces information like phone records, organizational charts, manuals and printouts of usernames and passwords (Laribee, 2006).
                  </p>
              ...
              <section>
                <p>
                  Technology-based social engineering requires an electronic interface to achieve the desired objective. This may involve using email, email attachment, and web sites. Examples of technology based attacks are phishing, spear phishing and pop-up windows.
                </p>
              </section>
              <section>
                  ...
                  <p>
                    The attacker composes an email that states that the target will be qualified to win. For example, an iPad can be given out to those who fill out a survey or questionnaire. The questionnaire will then request for very sensitive information of respondents
                  </p>
                  <p>
                    The victim gets the email, fills out the questions which require him to reply to the attacker by filling out a questionnaire. This will give the attacker an unlimited access to the victim’s personal details. Then the victim’s bank account would be emptied within a few minutes.
                  </p>
              </section>
            ...
            <div data-lesson='4' class="course-item" data-image='' data-image-credit=''>
              ...
              <section class="body">
                <h3 class="mb-4 mt-4">Multi-factor Authentication</h3>
                  ...
                  <p>
                    There is a need for employees to be trained through enlightenment programs so they will not fall prey to cyber criminals and make them see the importance of reporting promptly, scam emails that may be going around the organization and be sensitized on how to recognize spam like emails.
                  </p>

                  <p>
                    For example, employees do not look closely at the email address from which the email is coming from and to verify that it is a reliable email before opening or clicking any link in such emails or from any other messaging platforms.
                  </p>
                  <p>
              ...
              <section>
                <p>
                  <ol>
                    <li>Make sure you verify the identity of the sender of emails, SMS and phone calls, if something is off or looks suspicious report to the appropriate authority</li>

                    <li>Do not open or access attachment from emails from which you have not received prior communication</li>
                    ...
                    <li>Report any suspicious messages to the appropriate security</li>
                    <li>Follow all security guidelines in your organization and be ready to attend trainings of social engineering security</li>
